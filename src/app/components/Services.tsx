    ...
    <section>
      <div className="container max-w-[1160px] mx-auto py-32">
        ...
        <div className="mx-auto text-center  text-[#5a748e] w-[769px]">
          <h1 className="text-[44px] font-semibold">Beautiful. Clean. Responsive.</h1>
        ...
        <div className="grid grid-cols-3">
          ...
          <div className="grid grid-cols-[auto,1fr] gap-7  ">
            ...
            <div>
              <h1 className="mb-2 text-[#506a85] text-[26px] font-semibold">Passion</h1>
              <p className="text-[#73879c] text-[16px] text-ellipsis">
                Magnis modipsae que lib voloratati<br/>andigen daepeditem quiate re porem<br/>aut labor.Laceaque quiae sitiorem rest <br/> non restibusaes maio es dem tumquam<br/>core posae volor remped modis volor.
              </p>
            </div>
          </div>
          {/* service-2 */}
          <div className="grid grid-cols-[auto,1fr] gap-7  ">
            ...
            <div>
              <h1 className="mb-2 text-[#506a85] text-[26px] font-semibold">Creativity</h1>
              <p className="text-[#73879c] text-[16px] text-ellipsis">
                Magnis modipsae que lib voloratati<br/>andigen daepeditem quiate re porem<br/>aut labor.Laceaque quiae sitiorem rest <br/> non restibusaes maio es dem tumquam<br/>core posae volor remped modis volor.
              </p>
            </div>
          ...
          <div className="grid grid-cols-[auto,1fr] gap-7  ">
            ...
            <div>
              <h1 className="mb-2 text-[#506a85] text-[26px] font-semibold">Quality</h1>
              <p className="text-[#73879c] text-[16px] text-ellipsis">
                Magnis modipsae que lib voloratati<br/>andigen daepeditem quiate re porem<br/>aut labor.Laceaque quiae sitiorem rest <br/> non restibusaes maio es dem tumquam<br/>core posae volor remped modis volor.
              </p>
            </div>
